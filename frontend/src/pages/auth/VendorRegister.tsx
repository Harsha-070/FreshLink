...
import { Leaf, Phone, Mail, ArrowLeft, ShieldCheck, Sparkles, User, MapPin, Store, CreditCard } from 'lucide-react';
...
export default function VendorRegister() {
  ...
  const handleVerifyOtp = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      await verifyOtp(identifier.replace(/\s/g, ''), otp, 'vendor', name);
      // Update profile with additional details
      const profileUpdate: any = {};
      if (shopName) profileUpdate.shopName = shopName;
      if (shopAddress) profileUpdate.shopAddress = shopAddress;
      if (upiId) profileUpdate.upiId = upiId;
            ...
            >
              ...
              <form className="space-y-4" onSubmit={handleSendOtp}>
                ...
                <Button
                  ...
                  disabled={isLoading || !identifier || !name}
                >
                  {isLoading ? (
