...
import { Building2, Phone, Mail, ArrowLeft, ShieldCheck, Sparkles } from 'lucide-react';
...
export default function BusinessLogin() {
  ...
  const handleVerifyOtp = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      await verifyOtp(identifier.replace(/\s/g, ''), otp, 'business', name || undefined);
          ...
          {step === 'identifier' ? (
            ...
            >
              ...
              <form className="space-y-5" onSubmit={handleSendOtp}>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      placeholder={inputType === 'phone' ? '+91 98765 43210' : 'chef@restaurant.com'}
                      autoFocus
                    />
                  </div>
                </div>
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1.5">
                    Business Name <span className="text-slate-400">(optional, for new accounts)</span>
                  </label>
                  <Input
                    type="text"
                    value={name}
                    onChange={(e) => setName(e.target.value)}
                    className="h-12 text-base rounded-xl border-slate-200 focus:border-cyan-500 focus:ring-cyan-500"
